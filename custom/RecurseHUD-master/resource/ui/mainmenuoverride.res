...
//		"bgcolor_override"	"0 0 0 240"
	...
	"CallVoteButton"
	{
		...
		"SubButton"
		{
			...
			"image_drawcolor"			"RecurseWhite"
			"image_armedcolor"			"RecurseGrey"

			"paintbackground"			"1"
			"defaultBgColor_override"	"RecurseLightBG"
			"armedBgColor_override"		"RecurseDarkBG"
			"depressedBgColor_override"	"RecurseLightBG"
	...
	"ItemsButton"
	{
		...
		"image_drawcolor_override"	"RecurseWhite"
		"image_armedcolor_override"	"RecurseGrey"
	...
	"OptionsButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/options"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}
	}
	...
	"AdvancedOptionsButton"
	{
		...
		"SubImage"
		{
			...
			"visible"		"1"
			"enabled"		"1"
			"image"			"replay/thumbnails/adv_options"
			"scaleImage"	"1"
			"proportionaltoparent"	"1"
		}		
	}	
	...
	"Reload"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/reload"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}				
		}
	...
	"OnlyMenuBG"
	{
		...
		"SubButton"
		{
			...
			"autoResize"	"0"
			"pinCorner"		"3"
			"visible"		"0" // Set to 1 for solid background only @ Main Menu
			"enabled"		"1"
			"tabPosition"	"0"
			"font"			"RecurseMedium16"
			"textAlignment"	"center"
			...
			"defaultBgColor_override" "RecurseBG"
			"armedBgColor_override" "RecurseBG"
			"depressedBgColor_override" "RecurseBG"
	...
	"Notifications_ShowButtonPanel"
	{
		...
		"Notifications_ShowButtonPanel_SB"
		{
			...
			"SubImage"
			{
				...
				"visible"		"1"
				"enabled"		"1"
				"image"			"replay/thumbnails/alert" //"button_Alert"
				"scaleImage"	"1"
				"proportionaltoparent"	"1"
			}
		}
	...
	"WatchStreamButton"
	{
		...
		"SubButton"
		{
			...
			"defaultBgColor_override" "RecurseLightBG"
			"armedBgColor_override" "100 65 164 255"
			"depressedBgColor_override" "RecurseLightBG"
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/stream"
	...
	"QuestLogButton"
	{
		...
		"SubButton"
		{
			...
			"SubImage"
			{
				...
				"enabled"		"1"
				"scaleImage"	"1"
				"image"			"replay/thumbnails/tablet"
	...
	// May be readded
	"TFLogoImage" // Removed, but may be subject to change
	{
		"ControlName"	"ImagePanel"
	...
	"TFCharacterImage" // Removed, but may be subject to change
	{
		// "ControlName"	"ImagePanel"
